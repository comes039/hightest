...
class ReportOtherSymptomsUnrecordedFragment : Fragment() {

    private lateinit var binding: ReportOtherSymptomsUnrecordedBinding
    ...
    override fun onCreateView(
        ...
        binding = ReportOtherSymptomsUnrecordedBinding.inflate(layoutInflater)
