...
public class PieListAdapter extends BaseAdapter {
	...
	public View getView(int position, @Nullable View convertView, @Nullable ViewGroup parent) {
		...
		vh = new ViewHolder();
		convertView = LayoutInflater.from(context).inflate(R.layout.pie_item, parent, false);
		vh.name = (TextView) convertView.findViewById(R.id.pie_name);
		vh.percent = (TextView) convertView.findViewById(R.id.pie_percent);
		vh.entries = (TextView) convertView.findViewById(R.id.pie_entries);
		...
		String value = sampleData.getValue().toString();
		String sb = value + " entries";
		vh.entries.setText(sb);
